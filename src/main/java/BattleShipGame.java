...
public class BattleShipGame{
    ...
    private Logger Log = Logger.getLogger(BattleShipGame.class.getName());
    ...
    private Set<Integer> allShipCoordinates = new HashSet<>();
    ...
    void addShipCoordinates(int[] values){
    ...
    public GuessResult userGuesses(String input){
